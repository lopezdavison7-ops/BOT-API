...
// obtiene sus stickers y los envía individualmente
// como stickers de WhatsApp.
//
// Autor: BOT-API
// ============================================================
...
// Máximo de stickers por ejecución.
...
// Pie estándar de los mensajes del comando.
const FOOTER =
    '╰─〔 🤖 BOT-API 〕─╯';
...
function extraerStickers(
    ...
    // Busca sticker_1.png, sticker_2.png, etc.
    const regex =
