...
// ---------- SUBIR A TELEGRAPH (fallback si la API pide URL) ----------
...
// ---------- ANALIZAR IMAGEN (multipart → fallback URL) ----------
...
// ---------- MANEJADOR (se llama desde handler.js) ----------
export async function manejarDeteccion(sock, msg) {
    ...
    return false; // nunca bloquea el flujo de comandos
}